class GamePlayFa2 extends Phaser.Scene{
  ...
  create(){
    ...
    // 2) PLAYER
    this.player1 = this.physics.add.sprite(200, 300, 'chicken1dch').setScale(0.8).setDepth(2);
    this.player2 = this.physics.add.sprite(gameWidth-50, 400, 'chicken2dch').setScale(0.8).setDepth(2);
