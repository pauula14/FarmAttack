class TypeMenu extends Phaser.Scene{
  ...
  create(){
    ...
    //COOPERATIVE
    this.coopButton = this.add.image(gameWidth*8/16, gameHeight*8.3/16, 'playButton');
    this.coopButtonSel = this.add.image(gameWidth*8/16, gameHeight*8.3/16, 'playButtonSel');
    ...
    //COMPETITIVE
    this.compButton = this.add.image(gameWidth*8/16, gameHeight*10.4/16, 'tutorialButton');
    this.compButtonSel = this.add.image(gameWidth*8/16, gameHeight*10.4/16, 'tutorialButtonSel');
