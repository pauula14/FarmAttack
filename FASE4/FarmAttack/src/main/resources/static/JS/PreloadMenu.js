class PreloadMenu extends Phaser.Scene{
  ...
  preload(){
	...
	this.load.image('backgroundCHAT', '../ASSETS/Interface/ChatMenu/chat_menu_background.jpg');
    ...
    this.load.image('readyButton', '../ASSETS/Interface/WaitingRoomMenu/ReadyButton/ready_button_selected.png');
    this.load.image('readyButtonSel', '../ASSETS/Interface/WaitingRoomMenu/ReadyButton/ready_button.png');
    ...
    //PAUSE MENU
    this.load.image('backgroundPM', '../ASSETS/Interface/PauseMenu/pause_menu_background.png');
