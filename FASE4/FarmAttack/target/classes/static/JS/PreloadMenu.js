class PreloadMenu extends Phaser.Scene{
  ...
  preload(){
    ...
    //MULTIPLAYER
    this.load.image('fullLobby', '../ASSETS/Interface/WaitingRoomMenu/full_lobby_background.jpg');
    ...
    this.load.image('readyButton', '../ASSETS/Interface/WaitingRoomMenu/ReadyButton/ready_button.png');
